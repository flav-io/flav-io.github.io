...
| `<FL>(Bs->phiee)` | $\langle F_L\rangle(B_s\to \phi e^+e^-)$ | Binned Time-averaged longitudinal polarization fraction in $B_s\to \phi e^+e^-$ | `q2min`, `q2max` |
| `FL(Bs->phiee)` | $F_L(B_s\to \phi e^+e^-)$ | Time-averaged longitudinal polarization fraction in $B_s\to \phi e^+e^-$ | `q2` |
| `<S3>(Bs->phiee)` | $\langle S_3\rangle(B_s\to \phi e^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2min`, `q2max` |
| `S3(Bs->phiee)` | $S_3(B_s\to \phi e^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2` |
| `<S4>(Bs->phiee)` | $\langle S_4\rangle(B_s\to \phi e^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2min`, `q2max` |
| `S4(Bs->phiee)` | $S_4(B_s\to \phi e^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2` |
| `<S7>(Bs->phiee)` | $\langle S_7\rangle(B_s\to \phi e^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2min`, `q2max` |
| `S7(Bs->phiee)` | $S_7(B_s\to \phi e^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi e^+e^-$ | `q2` |
| `<dBR/dq2>(Bs->phiee)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B_s\to \phi e^+e^-)$ | Binned differential branching ratio of $B_s\to \phi e^+e^-$ | `q2min`, `q2max` |
| `dBR/dq2(Bs->phiee)` | $\frac{d\text{BR}}{dq^2}(B_s\to \phi e^+e^-)$ | Differntial branching ratio of $B_s\to \phi e^+e^-$ | `q2` |
| `<FL>(Bs->phimumu)` | $\langle F_L\rangle(B_s\to \phi \mu^+\mu^-)$ | Binned Time-averaged longitudinal polarization fraction in $B_s\to \phi \mu^+\mu^-$ | `q2min`, `q2max` |
| `FL(Bs->phimumu)` | $F_L(B_s\to \phi \mu^+\mu^-)$ | Time-averaged longitudinal polarization fraction in $B_s\to \phi \mu^+\mu^-$ | `q2` |
| `<S3>(Bs->phimumu)` | $\langle S_3\rangle(B_s\to \phi \mu^+\mu^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2min`, `q2max` |
| `S3(Bs->phimumu)` | $S_3(B_s\to \phi \mu^+\mu^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2` |
| `<S4>(Bs->phimumu)` | $\langle S_4\rangle(B_s\to \phi \mu^+\mu^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2min`, `q2max` |
| `S4(Bs->phimumu)` | $S_4(B_s\to \phi \mu^+\mu^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2` |
| `<S7>(Bs->phimumu)` | $\langle S_7\rangle(B_s\to \phi \mu^+\mu^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2min`, `q2max` |
| `S7(Bs->phimumu)` | $S_7(B_s\to \phi \mu^+\mu^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \mu^+\mu^-$ | `q2` |
| `<dBR/dq2>(Bs->phimumu)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B_s\to \phi \mu^+\mu^-)$ | Binned differential branching ratio of $B_s\to \phi \mu^+\mu^-$ | `q2min`, `q2max` |
| `dBR/dq2(Bs->phimumu)` | $\frac{d\text{BR}}{dq^2}(B_s\to \phi \mu^+\mu^-)$ | Differntial branching ratio of $B_s\to \phi \mu^+\mu^-$ | `q2` |
| `<FL>(Bs->phitautau)` | $\langle F_L\rangle(B_s\to \phi \tau^+\tau^-)$ | Binned Time-averaged longitudinal polarization fraction in $B_s\to \phi \tau^+\tau^-$ | `q2min`, `q2max` |
| `FL(Bs->phitautau)` | $F_L(B_s\to \phi \tau^+\tau^-)$ | Time-averaged longitudinal polarization fraction in $B_s\to \phi \tau^+\tau^-$ | `q2` |
| `<S3>(Bs->phitautau)` | $\langle S_3\rangle(B_s\to \phi \tau^+\tau^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2min`, `q2max` |
| `S3(Bs->phitautau)` | $S_3(B_s\to \phi \tau^+\tau^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2` |
| `<S4>(Bs->phitautau)` | $\langle S_4\rangle(B_s\to \phi \tau^+\tau^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2min`, `q2max` |
| `S4(Bs->phitautau)` | $S_4(B_s\to \phi \tau^+\tau^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2` |
| `<S7>(Bs->phitautau)` | $\langle S_7\rangle(B_s\to \phi \tau^+\tau^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2min`, `q2max` |
| `S7(Bs->phitautau)` | $S_7(B_s\to \phi \tau^+\tau^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phi \tau^+\tau^-$ | `q2` |
| `<dBR/dq2>(Bs->phitautau)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B_s\to \phi \tau^+\tau^-)$ | Binned differential branching ratio of $B_s\to \phi \tau^+\tau^-$ | `q2min`, `q2max` |
| `dBR/dq2(Bs->phitautau)` | $\frac{d\text{BR}}{dq^2}(B_s\to \phi \tau^+\tau^-)$ | Differntial branching ratio of $B_s\to \phi \tau^+\tau^-$ | `q2` |
...
| `<dBR/dq2>(B+->Kee)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B^+\to K^+e^+e^-)$ | Binned differential branching ratio of $B^+\to K^+e^+e^-$ | `q2min`, `q2max` |
...
| `<dBR/dq2>(B+->Kmumu)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B^+\to K^+\mu^+\mu^-)$ | Binned differential branching ratio of $B^+\to K^+\mu^+\mu^-$ | `q2min`, `q2max` |
...
| `<dBR/dq2>(B+->Ktautau)` | $\langle \frac{d\text{BR}}{dq^2} \rangle(B^+\to K^+\tau^+\tau^-)$ | Binned differential branching ratio of $B^+\to K^+\tau^+\tau^-$ | `q2min`, `q2max` |
