...
| `BR(Bs->emu)` | $B_s\to e^+\mu^-$ | Branching ratio of $B_s\to e^+\mu^-$. |  |
| `BR(B0->emu)` | $B^0\to e^+\mu^-$ | Branching ratio of $B^0\to e^+\mu^-$. |  |
| `BR(Bs->mue)` | $B_s\to \mu^+e^-$ | Branching ratio of $B_s\to \mu^+e^-$. |  |
| `BR(B0->mue)` | $B^0\to \mu^+e^-$ | Branching ratio of $B^0\to \mu^+e^-$. |  |
| `BR(Bs->etau)` | $B_s\to e^+\tau^-$ | Branching ratio of $B_s\to e^+\tau^-$. |  |
| `BR(B0->etau)` | $B^0\to e^+\tau^-$ | Branching ratio of $B^0\to e^+\tau^-$. |  |
| `BR(Bs->taue)` | $B_s\to \tau^+e^-$ | Branching ratio of $B_s\to \tau^+e^-$. |  |
| `BR(B0->taue)` | $B^0\to \tau^+e^-$ | Branching ratio of $B^0\to \tau^+e^-$. |  |
| `BR(Bs->mutau)` | $B_s\to \mu^+\tau^-$ | Branching ratio of $B_s\to \mu^+\tau^-$. |  |
| `BR(B0->mutau)` | $B^0\to \mu^+\tau^-$ | Branching ratio of $B^0\to \mu^+\tau^-$. |  |
| `BR(Bs->taumu)` | $B_s\to \tau^+\mu^-$ | Branching ratio of $B_s\to \tau^+\mu^-$. |  |
| `BR(B0->taumu)` | $B^0\to \tau^+\mu^-$ | Branching ratio of $B^0\to \tau^+\mu^-$. |  |
