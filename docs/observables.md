...
| `<FL>(Bs->phiee)` | $\langle F_L\rangle(B_s\to \phie^+e^-)$ | Binned Time-averaged longitudinal polarization fraction in $B_s\to \phie^+e^-$ | `q2min`, `q2max` |
| `FL(Bs->phiee)` | $F_L(B_s\to \phie^+e^-)$ | Time-averaged longitudinal polarization fraction in $B_s\to \phie^+e^-$ | `q2` |
| `<S3>(Bs->phiee)` | $\langle S_3\rangle(B_s\to \phie^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2min`, `q2max` |
| `S3(Bs->phiee)` | $S_3(B_s\to \phie^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2` |
| `<S4>(Bs->phiee)` | $\langle S_4\rangle(B_s\to \phie^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2min`, `q2max` |
| `S4(Bs->phiee)` | $S_4(B_s\to \phie^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2` |
| `<S7>(Bs->phiee)` | $\langle S_7\rangle(B_s\to \phie^+e^-)$ | Binned Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2min`, `q2max` |
| `S7(Bs->phiee)` | $S_7(B_s\to \phie^+e^-)$ | Time-averaged, CP-averaged angular observable in $B_s\to \phie^+e^-$ | `q2` |
| `<dBR/dq2>(Bs->phiee)` | $\langle \text{BR} \rangle(B_s\to \phie^+e^-)$ | Binned differential branching ratio of $B_s\to \phie^+e^-$ | `q2min`, `q2max` |
| `dBR/dq2(Bs->phiee)` | $\frac{d\text{BR}}{dq^2}(B_s\to \phie^+e^-)$ | Differntial branching ratio of $B_s\to \phie^+e^-$ | `q2` |
...
| `<dBR/dq2>(Bs->phimumu)` | $\langle \text{BR} \rangle(B_s\to \phi\mu^+\mu^-)$ | Binned differential branching ratio of $B_s\to \phi\mu^+\mu^-$ | `q2min`, `q2max` |
...
| `<dBR/dq2>(Bs->phitautau)` | $\langle \text{BR} \rangle(B_s\to \phi\tau^+\tau^-)$ | Binned differential branching ratio of $B_s\to \phi\tau^+\tau^-$ | `q2min`, `q2max` |
| `dBR/dq2(Bs->phitautau)` | $\frac{d\text{BR}}{dq^2}(B_s\to \phi\tau^+\tau^-)$ | Differntial branching ratio of $B_s\to \phi\tau^+\tau^-$ | `q2` |
| `<Rmue>(Bs->phill)` | $\langle R_{\mu e} \rangle(B_s\to \phi\ell^+\ell^-)$ | Ratio of partial branching ratios of $B_s\to \phi\mu^+ \mu^-$ and $B_s\to \phie^+ e^-$ | `q2min`, `q2max` |
