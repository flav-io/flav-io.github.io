...
Python version 3.10 or above and the Python package manager `pip` installed on your system.
...
The latest released version is available via [PyPI](https://pypi.org/), so
